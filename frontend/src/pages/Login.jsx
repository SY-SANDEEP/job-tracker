      ...
      <div style={{
        ...
        <div>
          ...
          <h1 style={{ fontSize: 34, fontWeight: 800, lineHeight: 1.3, marginBottom: 20, maxWidth: 420 }}>
            Welcome back. Your next offer is one application away.
          </h1>
          <p style={{ fontSize: 14, opacity: 0.85, lineHeight: 1.8, maxWidth: 380, marginBottom: 40 }}>
            Sign in to pick up right where you left off — your applications, AI insights, and interview prep are all here.
          </p>
        ...
        <div style={{
          background: 'rgba(255,255,255,0.12)', borderRadius: 14, padding: 18,
          display: 'flex', alignItems: 'center', gap: 12
        }}>
          <div style={{ width: 38, height: 38, borderRadius: 10, background: 'rgba(255,255,255,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 17, flexShrink: 0 }}>🤖</div>
          <p style={{ fontSize: 12, opacity: 0.9, lineHeight: 1.6 }}>
            New here? Our AI scores your resume against any job description in seconds.
          </p>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ width: 400 }}>
          <div style={{ marginBottom: 28 }}>
            <h2 style={{ fontSize: 24, fontWeight: 800, color: '#3C3A4D', marginBottom: 6 }}>Sign in to JobTrack</h2>
            <p style={{ color: '#6F6B7D', fontSize: 13 }}>Welcome back! Enter your details below.</p>
          </div>
          ...
          <p style={{ textAlign: 'center', marginTop: 24, color: '#6F6B7D', fontSize: 13 }}>
            Don't have an account? <Link to="/register" style={{ color: '#7367F0', fontWeight: 700, textDecoration: 'none' }}>Create one free</Link>
          </p>
        </div>
      </div>
    </div>
